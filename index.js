...
/**
 * [`rlp`](https://github.com/elementremjs/rlp)
 * @var {Function}
 */
exports.rlp = rlp
 ...
 * and the requirements of Elementrem.
...
/**
 * Returns the elementrem address of a given public key.
 * Accepts "Elementrem public keys" and SEC1 encoded keys.
...
/**
 * Returns the elementrem public key of a given private key
...
/**
 * Converts a public key to the Elementrem format.
 * @method importPublic
...
/**
 * Convert signature parameters into the format of `ele_sign` RPC method
 * @method toRpcSig
 * @param {Number} v
 * @param {Buffer} r
 * @param {Buffer} s
...
exports.toRpcSig = function (v, r, s) {
  // gele (and the RPC ele_sign method) uses the 65 byte format used by Bitcoin
  // FIXME: this might change in the future - https://github.com/elementrem/go-elementrem/issues/2053
  return exports.bufferToHex(Buffer.concat([ r, s, exports.toBuffer(v - 27) ]))
}

/**
 * Convert signature format of the `ele_sign` RPC method to signature parameters
 * NOTE: all because of a bug in gele: https://github.com/elementrem/go-elementrem/issues/2053
 * @method fromRpcSig
 * @param {String} sig
 * @return {Object}
 */
exports.fromRpcSig = function (sig) {
  ...
  var v = sig[64]
  // support both versions of `ele_sign` responses
  if (v < 27) {
    v += 27
  }
...
/**
 * Returns the elementrem address of a given private key
